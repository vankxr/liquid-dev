 ...
 */
static const void *body(md5_context_t *ctx, const void *data, uint32_t size)
{
    const uint8_t *ptr;
    uint32_t a, b, c, d;
...
void md5_update(md5_context_t *ctx, const void *data, uint32_t size)
{
    uint32_t saved_lo;
...
void md5_final(uint8_t *result, md5_context_t *ctx)
{
    uint32_t used, available;
